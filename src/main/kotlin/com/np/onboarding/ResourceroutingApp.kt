...
import com.np.onboarding.config.ApplicationProperties
...
class ResourceroutingApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes resourcerouting.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<ResourceroutingApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(ResourceroutingApp::class.java)
