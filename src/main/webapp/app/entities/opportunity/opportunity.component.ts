...
export class OpportunityComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.opportunityService
        ...
        .subscribe(
          (res: HttpResponse<IOpportunity[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInOpportunities(): void {
    this.eventSubscriber = this.eventManager.subscribe('opportunityListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IOpportunity[] | null, headers: HttpHeaders, page: number): void {
