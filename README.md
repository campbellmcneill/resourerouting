...
![CI](https://github.com/campbellmcneill/resourerouting/workflows/CI/badge.svg)
...
To build the final jar and optimize the resourcerouting application for production, run:
